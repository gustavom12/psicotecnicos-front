...
export default function MenuLeft() {
  return (<div className="flex flex-col  rounded-lg  h-screen " style={{ width: "240px", backgroundColor: "#F4F4F5" }}>
    ...
    <div className="flex flex-row justify-center items-center mt-4 h-16 ">
      <Star />
      <p className=" text-[#635BFF] font-semibold px-2 " style={{fontSize: "20px"}} >Psicotécnicos</p>
    </div>
    ...
    <div className="flex flex-col p-4">
      ...
      <button className="flex text-center px-2  py-2 w-[200px]">
        <Home />
        <p className="mx-4 text-[16px] font-normal text-[#3F3F46] px-2">Inicio</p>
      </button>

      <button className="flex text-center px-2  py-2 w-[200px]">
        <Modulo />
        <p className="mx-4 text-[16px] font-normal text-[#3F3F46] px-2">Módulos</p>
      </button>

      <button className="flex text-center px-2  py-2 w-[200px]">
        <Messages />
        <p className="mx-4 text-[16px] font-normal text-[#3F3F46] px-2">Entrevistas</p>
      </button>

      <button className="flex text-center px-2  py-2 w-[200px]">
        <Profesional />
        <p className="mx-4 text-[16px] font-normal text-[#3F3F46] px-2">Profesionales</p>
      </button>
      ...
      <button className="flex text-center px-2  py-2 w-[200px]">
        <Note />
        <p className="mx-4 text-[16px] font-normal text-[#3F3F46] px-2">Empresas</p>
      </button>
