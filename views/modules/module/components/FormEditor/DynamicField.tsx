                ...
                render={({ field: fld }) => (
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      onFieldChange({
                        target: {
                          name: `${namePrefix}.${index}.scaleMin`,
                          value: val,
                        },
                      });
                    }}
                ...
                render={({ field: fld }) => (
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      onFieldChange({
                        target: {
                          name: `${namePrefix}.${index}.scaleMax`,
                          value: val,
                        },
                      });
                    }}
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    if (val === "" || /^-?\d*\.?\d*$/.test(val)) {
                      ...
                      onFieldChange({
                        target: {
                          name: `${namePrefix}.${index}.numberValue`,
                          value: val,
                        },
                      });
                    }
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 bg-gray-50">
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        onFieldChange({
                          target: {
                            name: `${namePrefix}.${index}.selectedFiles`,
                            value: files,
                          },
                        });
                      }}
                ...
                render={({ field: fld }) => (
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      onFieldChange({
                        target: {
                          name: `${namePrefix}.${index}.maxFileSize`,
                          value: val,
                        },
                      });
                    }}
              ...
              render={({ field: fld }) => (
                <input
                  ...
                  onChange={(e) => {
                    ...
                    onFieldChange({
                      target: {
                        name: `${namePrefix}.${index}.multipleFiles`,
