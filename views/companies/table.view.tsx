  ...
  const loadData = async () => {
    try {
      ...
      try {
        ...
        console.log(
          "Companies from /companies endpoint:",
          companiesAltRes.data,
        );
      } catch (error) {
      ...
      if (companiesData.length > 0) {
        ...
        console.log(
          "Available fields in first company:",
          Object.keys(companiesData[0]),
        );
        ...
        console.log(
          `Companies with status: ${companiesWithStatus.length}/${companiesData.length}`,
        );
        console.log(
          `Companies with email: ${companiesWithEmail.length}/${companiesData.length}`,
        );
      }
      ...
      console.log(
        "Processing interviews for companies:",
      ...
      interviewsData.forEach((interview) => {
        ...
        if (companyId) {
          interviewsCountMap[companyId] =
            (interviewsCountMap[companyId] || 0) + 1;
          console.log(
            `Interview ${interview._id} assigned to company ${companyId}`,
          );
        }
      });
